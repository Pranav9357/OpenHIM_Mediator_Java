...
public class MediatorMain {
    ...
    public static void postRequest() throws IOException {
        ...
        InputStream inputstream = MediatorMain.class.getClassLoader().getResourceAsStream(propFile);
        ...
        URL url = new URL(prop.getProperty("config.url"));
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setDoInput(true);
        connection.setDoOutput(true);
        connection.setRequestMethod(prop.getProperty("config.requestMethod"));
        connection.setRequestProperty("Authorization", prop.getProperty("config.token"));
        connection.setRequestProperty("Accept", "application/json");
        connection.setRequestProperty("Content-Type", "application/json");

        String data = prop.getProperty("config.requestBodyData");
